...
const ManageProjectCreate = () => {
    ...
    const onSubmit: SubmitHandler<FieldValues> = async (data) => {
        ...
        const formattedData = {
            ...
            keyFeatures: [data.keyFeatures[0], data.keyFeatures[1], data.keyFeatures[2]], // assuming 3 key features
        };
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div>
                            ...
                            {errors.liveSite && <p className="text-red-300 text-sm">{errors.liveSite.message}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.clientSiteGitHub && <p className="text-red-300 text-sm">{errors.clientSiteGitHub.message}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.serverSiteGitHub && <p className="text-red-300 text-sm">{errors.serverSiteGitHub.message}</p>}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        {errors.keyFeatures && <p className="text-red-300 text-sm">{errors.keyFeatures.message}</p>}
                    </div>

                    {/* Submit Button */}
                    <Button type="submit" className="w-full bg-[#019fc7] text-white font-medium py-2 rounded-lg hover:bg-[#019fc7] focus:outline-none cursor-pointer">Add Project</Button>
                </form>
            </div>
        </div>
    );
...
export default ManageProjectCreate;
